...
&end-lon=30.035684
&level=econom
&ref=https%3A%2F%2Firinanails.by
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none" viewBox="0 0 32 32">
  ...
  <defs>
    ...
    <span class="font-bold row-span-1 col-span-3">Доехать на такси до</span>
    <span class="row-span-1 col-span-3 opacity-70">улица Петровского, 44</span>
  </a>
</template>

<style lang="scss" module>
.yandexTaxiBtn {
  @apply w-[16.5rem] bg-white rounded-lg px-4 py-2 grid grid-rows-2 grid-cols-4 items-center hover:scale-110 transition-all;
